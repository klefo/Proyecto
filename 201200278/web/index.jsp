<%-- 
    Document   : index
    Created on : 06/10/2013, 01:22:07 PM
    Author     : Omar
--%>
...
-->
    ...
    <body bgcolor="#FFFFFF" onLoad="JavaScript:format(0)" style="">
...
<form target="mainFrame" method="post" name="mainForm" action="encontrar">
     ...
     <tr>
      <td>
       <table cellspacing="2" cellpadding="3" width="100%" border="0">
        <tbody>
         <tr>
          <td height="181" align="left" bgcolor="#3399cc"><p><img src="imagen/cobrar.jpg" width="1175" height="561"></p>
   ...
   %>
   <p class="gamma-pos-alert Estilo2">Contribuyente: <%= snombre %> </p>
